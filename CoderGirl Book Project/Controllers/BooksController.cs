...
namespace CoderGirl_Book_Project.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Cover,Description")] Books books)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Cover,Description")] Books books)
        {
            if (id != books.Id)
            {
                return NotFound();
